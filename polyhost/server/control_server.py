...
class ControlServer(MpcListenerServer):
    ...
    def _build_registry(self):
        ...
        return {
            ...
            p.M_AI_STATE_SET: lambda conn, params: _unwrap(c.set_ai_state(params["value"])),
            p.M_AI_STATE_GET: lambda conn, params: _unwrap(c.get_ai_state()),
            p.M_AI_STATUS: lambda conn, params: _unwrap(c.ai_status()),
            p.M_AI_TARGET_SET: lambda conn, params: _unwrap(c.set_ai_target(params.get("pattern", ""))),
