...
M_KEYMAP_LAYER_NAMES = "keymap.layer_names"      # {} -> (ok, [str, ...])
...
M_FONTPACK_SYNC = "fontpack.sync"      # {"force": bool=False} -> {"queued","force"}; flashes the
                                       # stale + previously-failed bundles, or ALL when force
