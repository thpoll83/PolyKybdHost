...
class CommandsSubMenu:
    ...
    def build_menu(self, parent_menu):
        cmd_menu = parent_menu.addMenu(QIcon(os.path.join(pathlib.Path(__file__).parent.resolve(), "res/icons/settings.svg")), "All PolyKybd Commands")

        action = QAction(QIcon(os.path.join(pathlib.Path(__file__).parent.resolve(), "res/icons/toggle_off.svg")), "Stop Idle", parent=self.parent)
        action.setData(False)
        action.triggered.connect(self.change_idle)
        cmd_menu.addAction(action)

        action = QAction(QIcon(os.path.join(pathlib.Path(__file__).parent.resolve(), "res/icons/toggle_on.svg")), "Start Idle", parent=self.parent)
        action.setData(True)
        action.triggered.connect(self.change_idle)
        cmd_menu.addAction(action)

        action = QAction(QIcon(os.path.join(pathlib.Path(__file__).parent.resolve(), "res/icons/delete.svg")), "Reset Overlays Buffers", parent=self.parent)
        action.triggered.connect(self.reset_overlays)
        cmd_menu.addAction(action)

        action = QAction(QIcon(os.path.join(pathlib.Path(__file__).parent.resolve(), "res/icons/toggle_on.svg")), "Enable Shortcut Overlays", parent=self.parent)
        action.triggered.connect(self.enable_overlays)
        cmd_menu.addAction(action)

        action = QAction(QIcon(os.path.join(pathlib.Path(__file__).parent.resolve(), "res/icons/toggle_off.svg")), "Disable Shortcut Overlays", parent=self.parent)
        ...
        action = QAction(QIcon(os.path.join(pathlib.Path(__file__).parent.resolve(), "res/icons/backlight_high_off.svg")), "Off", parent=self.parent)
        action.setData(0)
        action.triggered.connect(self.set_brightness)
        bri_menu.addAction(action)

        action = QAction(QIcon(os.path.join(pathlib.Path(__file__).parent.resolve(), "res/icons/backlight_low.svg")), "1%", parent=self.parent)
        action.setData(2)
        action.triggered.connect(self.set_brightness)
        bri_menu.addAction(action)

        action = QAction(QIcon(os.path.join(pathlib.Path(__file__).parent.resolve(), "res/icons/backlight_high.svg")), "50%", parent=self.parent)
        action.setData(25)
        action.triggered.connect(self.set_brightness)
        bri_menu.addAction(action)

        action = QAction(QIcon(os.path.join(pathlib.Path(__file__).parent.resolve(), "res/icons/backlight_high.svg")), "100%", parent=self.parent)
        action.setData(50)
        action.triggered.connect(self.set_brightness)
        bri_menu.addAction(action)
