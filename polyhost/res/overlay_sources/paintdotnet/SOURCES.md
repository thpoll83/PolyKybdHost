...
before drawing a substitute.** What makes this one different is that Paint.NET
stopped publishing source after 3.36.7, so there is no repository to take the
current icon from at any licence. Hence a **curated generic**
...
69 of 75 are Fluent (MIT, some with a digit composited over); the rest are drawn.
