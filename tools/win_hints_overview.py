...
SECTIONS = [
    ("Win + <key>", [
        ...
        ("Win+I", "Settings",             [0xA2], 4, False),
        ("Win+K", "Cast",                 [0xA3], 4, False),
        ...
        ("Win+Left",  "Snap left",        [0xA0], 6, False),
        ("Win+Right", "Snap right",       [0xA1], 6, False),
        ("Win+Up",    "Maximize",         [0x1F5D6], 5, False),
        ("Win+Down",  "Minimize",         [0x1F5D7], 5, False),
        ("Win+Tab",   "Task view",        [0xA4], 5, False),
        ("Win+Pause", "System properties",[0xA5], 6, False),
        ("Win+PrtScn","Screenshot",       [0x1F4F7], 3, False),
        ("Win + +",   "Magnifier in",     [0x9E], 6, False),
        ("Win + -",   "Magnifier out",    [0x9F], 6, False),
    ]),
